...
const PEDIA_INLINE_ICON_DEFINITIONS = [
	{ templates: ["Bananas", "Bananas Icon"], label: "Bananas", fileName: "Bananas_Icon.png" },
	{ templates: ["Cattle", "Cattle Icon"], label: "Cattle", fileName: "Cattle_Icon.png" },
	{ templates: ["Citizen", "Citizen Icon"], label: "Citizens", fileName: "Citizen.png" },
	{ templates: ["Citrus", "Citrus Icon"], label: "Citrus", fileName: "Citrus_Icon.png" },
	{ templates: ["Copper", "Copper Icon"], label: "Copper", fileName: "Copper_Icon.png" },
	{ templates: ["Coal", "Coal Icon"], label: "Coal", fileName: "Coal_Icon.png" },
	{ templates: ["Crabs", "Crabs Icon"], label: "Crabs", fileName: "Crabs_Icon.png" },
	...
	{ templates: ["Deer", "Deer Icon"], label: "Deer", fileName: "Deer_Icon.png" },
	{ templates: ["Defense Icon", "Strength Icon"], label: "Strength", fileNames: "Strength.png" },
	{ templates: ["Diplomat", "Diplomat Icon"], label: "Diplomats", fileName: "Diplomat.png" },
	{ templates: ["Dyes", "Dyes Icon"], label: "Dyess", fileName: "Dyes_Icon.png" },
	...
	{ templates: ["Ivory", "Ivory Icon"], label: "Ivory", fileName: "Ivory_Icon.png" },
	{ templates: ["Iron", "Iron Icon"], label: "Iron", fileName: "Iron_Icon.png" },
	...
	{ templates: ["Marble Icon"], label: "Marbles", fileName: "Marble_icon.png" },
	...
	{ templates: ["Resistance", "Resistance Icon"], label: "Resistance", fileName: "Resistance.png" },
	{ templates: ["Science Icon", "Research Icon"], label: "Science", fileName: "Science.png" },
	{ templates: ["Spy", "Spy Icon"], label: "Spy", fileName: "SpyIcon.png" },
	...
	{ templates: ["Aluminum Icon"], label: "Aluminum", fileName: "Aluminum.png" },
	{ templates: ["ClaimWeak"], label: "Claim Weak", fileName: "Claimweak.png" },
	{ templates: ["Coal Icon"], label: "Coal", fileName: "Coal.png" },
	{ templates: ["CrimeLightBlue"], label: "Crime Light Blue", fileName: "Crimelightblue.png" },
	{ templates: ["Crimes"], label: "Crimes", fileName: "Crimes.png" },
	{ templates: ["CrimesBlue"], label: "Crimes Blue", fileName: "Crimesblue.png" },
	{ templates: ["CrimesCyan"], label: "Crimes Cyan", fileName: "Crimescyan.png" },
	{ templates: ["CrimesGreen"], label: "Crimes Green", fileName: "Crimesgreen.png" },
	{ templates: ["CrimesOrange"], label: "Crimes Orange", fileName: "Crimesorange.png" },
	{ templates: ["CrimesPink"], label: "Crimes Pink", fileName: "Crimespink.png" },
	{ templates: ["CrimesPurple"], label: "Crimes Purple", fileName: "Crimespurple.png" },
	{ templates: ["CrimesRed"], label: "Crimes Red", fileName: "Crimesred.png" },
	{ templates: ["CrimesSilver"], label: "Crimes Silver", fileName: "Crimessilver.png" },
	{ templates: ["CrimesWhite"], label: "Crimes White", fileName: "Crimeswhite.png" },
	{ templates: ["CrimesYellow"], label: "Crimes Yellow", fileName: "Crimesyellow.png" },
	{ templates: ["OrganizedCrime"], label: "Organized Crime", fileName: "Organizedcrime.png" },
	{ templates: ["Development"], label: "Development", fileName: "Development.png" },
	{ templates: ["Claim"], label: "Claim", fileName: "Claim.png" },
	{ templates: ["ClaimStrong"], label: "Claim Strong", fileName: "Claimstrong.png" },
	{ templates: ["Colony"], label: "Colony", fileName: "Colony.png" },
	{ templates: ["Disease"], label: "Disease", fileName: "Disease.png" },
	{ templates: ["Elector"], label: "Elector", fileName: "Elector.png" },
	{ templates: ["Faction"], label: "Faction", fileName: "Faction.png" },
	{ templates: ["Furs"], label: "Furs", fileName: "Furs_Icon.png" },
	{ templates: ["Vote"], label: "Vote", fileName: "Vote.png" },
	{ templates: ["Great Explorer Icon"], label: "Great Explorer", fileName: "Greatexplorer.png" },
	{ templates: ["Health", "HealthIcon"], label: "Health", fileName: "Health.png" },
	{ templates: ["Iron Icon"], label: "Iron", fileName: "Iron.png" },
	{ templates: ["Incense Icon"], label: "Incense", fileName: "Incense_Icon.png" },
	{ templates: ["Legitimacy"], label: "Legitimacy", fileName: "Legitimacy.png" },
	{ templates: ["Loyalty", "Loyalty Icon"], label: "Loyalty", fileName: "Loyalty.png" },
	{ templates: ["LoyaltyGreen"], label: "Loyalty Green", fileName: "Loyaltygreen.png" },
	{ templates: ["LoyaltyRed"], label: "Loyalty Red", fileName: "Loyaltyred.png" },
	{ templates: ["LoyaltySilver"], label: "Loyalty Silver", fileName: "Loyaltysilver.png" },
	{ templates: ["LoyaltyYellow"], label: "Loyalty Yellow", fileName: "Loyaltyyellow.png" },
	{ templates: ["Magistrates Icon"], label: "Magistrates", fileName: "Magistrates.png" },
	{ templates: ["Oil Icon"], label: "Oil", fileName: "Oil.png" },
	{ templates: ["Paper CSD Icon"], label: "Paper CSD", fileName: "Papercsd.png" },
	{ templates: ["Piety Icon"], label: "Piety", fileName: "Piety.png" },
	{ templates: ["Plague"], label: "Plague", fileName: "Plague.png" },
	{ templates: ["Power"], label: "Power", fileName: "Power.png" },
	{ templates: ["Prestige Icon"], label: "Prestige", fileName: "Prestige.png" },
	{ templates: ["Prosperity"], label: "Prosperity", fileName: "Prosperity.png" },
	{ templates: ["Reform"], label: "Reform", fileName: "Reform.png" },
	{ templates: ["Senator"], label: "Senator", fileName: "Senator.png" },
	{ templates: ["Slavery"], label: "Slavery", fileName: "Slavery.png" },
	{ templates: ["Salt"], label: "Salt", fileName: "Salt_Icon.png" },
	{ templates: ["Sheep"], label: "Sheep", fileName: "Sheep_Icon.png" },
	{ templates: ["Silk"], label: "Silk", fileName: "Silk_Icon.png" },
	{ templates: ["Silver"], label: "Silver", fileName: "Silver_Icon.png" },
	{ templates: ["Sovereignty"], label: "Sovereignty", fileName: "Sovereignty.png" },
	{ templates: ["Stone"], label: "Stone", fileName: "Stone_Icon.png" },
	{ templates: ["Sugar"], label: "Sugar", fileName: "Sugar_Icon.png" },
	{ templates: ["Trade Icon"], label: "Trade", fileName: "Trade.png" },
	{ templates: ["Tribes"], label: "Tribes", fileName: "Tribes.png" },
	{ templates: ["Truffles"], label: "Truffles", fileName: "Truffles_Icon.png" },
	{ templates: ["Unhappiness Icon"], label: "Unhappiness", fileName: "Unhappiness.png" },
	{ templates: ["Uranium Icon"], label: "Uranium", fileName: "Uranium.png" },
	{ templates: ["War Icon"], label: "War", fileName: "War.png" },
	{ templates: ["Whales_Icon Icon"], label: "Whales_Icon", fileName: "Whales_Icon.png" },
];
...
export const PEDIA_INLINE_ICON_HELPER_TEMPLATES = [
	"Food Icon",
	"Production Icon",
	"Gold Icon",
	"Science Icon",
...
const HELPER_TEMPLATE_KEYS = new Set(PEDIA_INLINE_ICON_HELPER_TEMPLATES.map((template) => normalizeLookupKey(template)));

export const PEDIA_INLINE_ICONS_FOR_HELPER = PEDIA_INLINE_ICONS.filter((icon) => HELPER_TEMPLATE_KEYS.has(normalizeLookupKey(icon.template)));
